...
public class HierarchicalCacheTest {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        HierarchicalCache cache = new HierarchicalCache(100, 1000, "C:\\Codebase\\my-caching-project\\my-caching-project\\src\\main\\java\\com\\cache\\usercase\\usercase2\\l3cache");
